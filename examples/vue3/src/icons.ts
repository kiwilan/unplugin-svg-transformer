...
export const iconList: Record<IconType, Promise<{ default: string }>> = {
  'download-copy-2': () => import('../node_modules/unplugin-svg-transformer/cache/download copy 2'),
  'download-copy': () => import('../node_modules/unplugin-svg-transformer/cache/download copy'),
